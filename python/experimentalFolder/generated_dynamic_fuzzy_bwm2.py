...
def solve_lp():
    ...
    model += 1+w1l-w3l*(5/2)>=b
    model += -1<=w1l-w3l*(5/2)
    model += w1l-w3l*(5/2) <= -0.0000000000000001e-05
    model += 1+w1m-w3m*3>=b
    model += -1<=w1m-w3m*3
    model += w1m-w3m*3 <= -0.0000000000000001e-05
    model += 1+w1u-w3u*(7/2)>=b
    model += -1<=w1u-w3u*(7/2)
    model += w1u-w3u*(7/2) <= -0.0000000000000001e-05
    model += 1-w1l+(5/2)*w3l>=b
    model += 0<=w1l-(5/2)*w3l
    model += w1l-(5/2)*w3l<=1
    model += 1-w1m+3*w3m>=b
    model += 0<=w1m-3*w3m
    model += w1m-3*w3m<=1
    model += 1-w1u+(7/2)*w3u>=b
    model += 0<=w1u-(7/2)*w3u
    model += w1u-(7/2)*w3u<=1
